...
from api.mixins import ViewContextMixin
from api.filters import CustomFilterBackend, CustomSearchFilter
...
class BaseActionsModelViewSet(ViewContextMixin, viewsets.ModelViewSet):
    ...
    permission_classes = (custom_permissions.AdminOnlyWRITEPermission, )
    class Meta:
        abstract = True
